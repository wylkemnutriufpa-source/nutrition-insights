...
const App = () => {
  ...
  const Switcher = () => (
    <motion.button
      ...
      className={`fixed top-[15px] right-[215px] z-[9999] px-2 py-1 rounded-md text-[9px] font-bold uppercase transition-colors shadow-sm border flex items-center gap-1.5 cursor-move select-none ${
        mode === 'V1'
