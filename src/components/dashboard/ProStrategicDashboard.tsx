...
const STRATEGIC_CARDS = [
  ...
  { key: "editor-v3", label: "Editor Elite V3", description: "Modo avançado (Semana/Dia)", icon: Sparkles, route: "/editor-v3", gradient: "from-purple-500/10 to-purple-600/5", badge: "Elite" },
