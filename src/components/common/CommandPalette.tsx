...
const allRoutes = [
  ...
  { to: "/food-database", icon: Apple, label: "Banco de Alimentos", keywords: "banco alimentos database comida ingredientes tabela nutricional taco ibge", roles: ["nutritionist", "admin", "patient"], desc: "Base de dados de alimentos" },
