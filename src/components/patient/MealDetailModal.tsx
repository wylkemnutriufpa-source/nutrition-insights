  ...
  return (
    <>
      ...
      <DialogContent className="max-w-lg max-h-[90vh] p-0 overflow-hidden rounded-2xl border-border/50 shadow-2xl backdrop-blur-sm">
        ...
        {/* Tags row */}
        {!isBasic && (goalTag || (showTechnicalDetails && (clinicalTags.length > 0 || source === "library")) || prepTime) && (
        ...
        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 sm:px-6 pb-8 space-y-6 max-h-[calc(90vh-160px)] custom-scrollbar">
          {/* Macros */}
