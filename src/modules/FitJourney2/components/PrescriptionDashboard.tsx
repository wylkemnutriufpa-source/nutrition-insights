      ...
      <div className="min-h-screen bg-black text-white p-6 animate-pulse">
        <div className="flex justify-between items-center mb-10">
          <div className="space-y-2">
            <div className="h-9 w-48 bg-slate-800 rounded" />
        ...
        <div className="h-[400px] bg-slate-900/30 border border-slate-800 rounded-2xl" />
      </div>
    );
  }
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                <StaggerItem index={5}>
                  <h2 className="text-xl font-black uppercase tracking-tight mb-6">Atalhos</h2>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="relative">
                      <SelectionRipple className="rounded-2xl">
                        <button 
                          onClick={() => setShowPatientList(!showPatientList)}
                    ...
                    <SelectionRipple className="rounded-2xl">
                      <button className="w-full flex items-center gap-4 p-4 bg-slate-900 border border-slate-800 rounded-2xl text-left hover:bg-slate-800 transition-colors">
