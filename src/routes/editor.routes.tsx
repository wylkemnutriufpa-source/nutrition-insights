...
import { RedirectWithParams } from "./RouteHelpers";
...
export const editorRoutes = [
  ...
  <Route key="v3-params-redirect" path="/v3/:patientId" element={<RedirectWithParams to="/editor-v3/:patientId" />} />,
  <Route key="meal-plans-editor-v3-redirect" path="/meal-plans/editor/v3" element={<Navigate to="/editor-v3" replace />} />,
  <Route key="diet-builder-redirect" path="/diet-builder" element={<Navigate to="/editor-v3" replace />} />,
  <Route key="meal-plan-editor-v3-redirect" path="/meal-plan-editor-v3" element={<Navigate to="/editor-v3" replace />} />,
  ...
  <Route key="recipe-builder" path="/recipe-builder" element={<ProtectedRoute><WorkspaceRouteGuard><Suspense fallback={<PageLoader />}><RecipeBuilder /></Suspense></WorkspaceRouteGuard></ProtectedRoute>} />,
  ...
  <Route key="automation" path="/automation" element={<ProtectedRoute><WorkspaceRouteGuard><Suspense fallback={<PageLoader />}><AutomationCenter /></Suspense></WorkspaceRouteGuard></ProtectedRoute>} />,
