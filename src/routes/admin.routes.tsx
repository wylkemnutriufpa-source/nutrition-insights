...
export const adminRoutes = [
  ...
  <Route key="admin-nutrition-audit" path="/admin/nutrition-audit" element={<ProtectedRoute><WorkspaceRouteGuard><Suspense fallback={<PageLoader />}><TemplateNutritionAudit /></Suspense></WorkspaceRouteGuard></ProtectedRoute>} />,
