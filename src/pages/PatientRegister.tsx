...
export default function PatientRegister() {
  ...
  // REMOVIDO: Tela de bloqueio "Validando convite..." removida para evitar travas de UX.
  // A validação agora ocorre em background enquanto o usuário preenche o formulário.
