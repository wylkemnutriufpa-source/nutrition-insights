...
const SLIDES: SlideData[] = [
  {
    image: slide1,
    caption: "A evolução da Nutrição Clínica Inteligente",
    detail:
      "O FitJourney une dados, metabolismo e estratégia em uma plataforma única — para que você tome decisões clínicas com confiança absoluta.",
  },
  {
    image: slide2,
    caption: "Dashboard Clínico & Cockpit de Decisões",
    detail:
      "Visualize toda sua carteira de pacientes, riscos de abandono, scores de adesão e alertas clínicos em tempo real — tudo num único painel.",
  },
  {
    image: slide3,
    caption: "Editor de Planos Alimentares Premium",
    detail:
      "Monte planos alimentares em minutos com grade semanal visual, biblioteca de refeições, geração automática e controle de macros em tempo real.",
  },
  {
    image: slide4,
    caption: "Inteligência Preditiva & Motor Clínico",
    detail:
      "O FitJourney analisa padrões metabólicos e comportamentais para prever estagnação antes que ela aconteça — com recomendações proativas.",
  },
  {
    image: slide5,
    ...
    >
      ...
      <div>
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight">
          Você agora possui um cockpit de<br />nutrição clínica inteligente
        </h2>
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
        <Button
          onClick={onComplete}
          className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white h-12 text-sm font-semibold shadow-lg shadow-emerald-900/30 border-0"
        >
        ...
        <Button
          ...
          variant="outline"
          className="flex-1 border-emerald-600/40 text-emerald-400 hover:bg-emerald-600/10 h-12 text-sm font-semibold"
        >
      ...
      <Button
        onClick={() => onNavigate("/editor-v2")}
        variant="ghost"
        className="text-white/40 hover:text-white/70 text-xs"
      >
        <Sparkles className="w-3 h-3 mr-1" />
        Explorar Editor Premium
      </Button>
    </motion.div>
  );
}
