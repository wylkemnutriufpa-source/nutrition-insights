      ...
      <main className="max-w-4xl mx-auto px-6 pt-8 space-y-8">
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <div className="text-xs font-bold text-slate-400 bg-slate-100 px-3 py-1 rounded-full">MODO SIMPLES</div>
          </div>
        ...
        {/* Footer de Ação */}
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] max-w-md">
          <Button 
