    ...
    <div className="min-h-screen bg-[#0a0a14] text-white overflow-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex gap-3">
          <Link to="/">
            <Button variant="ghost" size="sm" className="text-white/60 hover:text-white">Voltar</Button>
          </Link>
          <Link to="/auth">
            <Button size="sm" className="bg-emerald-500 hover:bg-emerald-600 text-white">Entrar</Button>
          </Link>
        </div>
      </nav>
      ...
      <section className="relative px-6 pt-16 pb-24 max-w-6xl mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm mb-6">
            <Sparkles className="w-4 h-4" /> Programa de Acompanhamento Online Inteligente
          </div>
          ...
          <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Acompanhamento nutricional inteligente com gamificação, IA e comunicação direta
            com seu nutricionista. Tudo no seu celular.
          </p>
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Tudo que você precisa para{" "}
            <span className="text-emerald-400">resultados reais</span>
          </h2>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="text-5xl font-black bg-gradient-to-b from-emerald-400 to-emerald-600 bg-clip-text text-transparent mb-4">
                {s.step}
              </div>
      ...
      <section className="px-6 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Pronto para começar sua <span className="text-emerald-400">transformação</span>?</h2>
          <p className="text-white/40 mb-8">Converse com seu nutricionista sobre o FitJourney e comece sua jornada hoje.</p>
          <Link to="/auth">
