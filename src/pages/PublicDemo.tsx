...
import { ArrowLeft, Rocket, Play, Stethoscope, User, Brain, Trophy, BarChart3, MessageSquare, Calendar, Shield, Zap, Target, Sparkles, ChevronRight } from "lucide-react";
...
const PRO_SECTIONS: ShowcaseSection[] = [
  {
    ...
    title: "Dashboard Clínico Inteligente",
    subtitle: "Cockpit de Decisões",
    description: "Visualize riscos de abandono, scores de adesão e alertas clínicos em tempo real — tudo num único painel profissional.",
    icon: <BarChart3 className="w-5 h-5" />,
  },
  {
    image: slide2,
    title: "Cockpit de Pacientes",
    subtitle: "Carteira sob controle total",
    description: "Gerencie toda sua base de pacientes com indicadores de prioridade, status de adesão e alertas automáticos.",
    icon: <Target className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(210,92%,55%)",
    glowColor2: "hsl(152,58%,45%)",
  },
  {
    image: screenshotMealPlan,
    title: "Editor de Planos Alimentares",
    subtitle: "Monte planos em minutos",
    description: "Grade semanal visual, biblioteca de refeições, geração automática e controle de macros em tempo real.",
    icon: <Calendar className="w-5 h-5" />,
    glowColor1: "hsl(152,58%,45%)",
    glowColor2: "hsl(45,93%,47%)",
  },
  {
    image: slide4,
    title: "Motor de Inteligência Preditiva",
    subtitle: "Antecipe problemas antes que aconteçam",
    description: "Análise de padrões metabólicos e comportamentais para prever estagnação — com recomendações proativas.",
    icon: <Brain className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(280,70%,50%)",
    glowColor2: "hsl(210,92%,55%)",
  },
  {
    image: slide5,
    title: "Gamificação & Engajamento",
    subtitle: "Escale seu consultório com tecnologia",
    description: "Sistema de pontos, ranking global, protocolos especiais e ferramentas de crescimento integradas.",
    icon: <Trophy className="w-5 h-5" />,
    glowColor1: "hsl(45,93%,47%)",
    glowColor2: "hsl(152,58%,45%)",
  },
  {
    image: slide6,
    title: "Protocolos Clínicos Estruturados",
    subtitle: "Metodologia científica no dia a dia",
    description: "Fases, tarefas diárias e transições automáticas baseadas na evolução do paciente.",
    icon: <Shield className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(210,92%,55%)",
    glowColor2: "hsl(280,70%,50%)",
  },
  {
    image: slide7,
    title: "Relatórios & Analytics Avançados",
    subtitle: "Dados que impressionam e convencem",
    description: "Relatórios automáticos com gráficos de evolução, comparativos e exportação em PDF profissional.",
    icon: <BarChart3 className="w-5 h-5" />,
    glowColor1: "hsl(152,58%,45%)",
    glowColor2: "hsl(210,92%,55%)",
  },
  {
    image: slide8,
    title: "Engajamento Inteligente",
    subtitle: "Comunicação que gera resultados",
    description: "Check-ins automáticos, acompanhamento contínuo e motivação baseada em dados reais de adesão.",
  ...
  },
  {
    ...
    subtitle: "IA sob sua supervisão total",
    description: "Análise de refeições, geração de receitas, insights de anamnese e suporte à decisão clínica.",
  ...
  {
    image: slide10,
    title: "Escale Seu Consultório",
    subtitle: "De consultório local a marca digital",
    description: "Landing pages, afiliados, agendamento online, pagamentos via Stripe e ferramentas de crescimento.",
...
const PATIENT_SECTIONS: ShowcaseSection[] = [
  {
    ...
    description: "O FitJourney acompanha sua evolução todos os dias com inteligência e cuidado.",
    icon: <Sparkles className="w-5 h-5" />,
  },
  {
    image: pSlide2,
    title: "Seu plano alimentar inteligente",
    subtitle: "Tudo pensado para seu objetivo",
    description: "Toque em qualquer refeição para ver ingredientes, modo de preparo e macros.",
    icon: <Calendar className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(210,92%,55%)",
    glowColor2: "hsl(152,58%,45%)",
  },
  {
    ...
    description: "Registre peso, medidas e fotos. Veja sua evolução semana após semana.",
    icon: <BarChart3 className="w-5 h-5" />,
    glowColor1: "hsl(152,58%,45%)",
    glowColor2: "hsl(45,93%,47%)",
  },
  {
    image: pSlide4,
    title: "Missões e motivação diária",
    subtitle: "Pequenas vitórias, grandes resultados",
    description: "Complete tarefas, ganhe XP, mantenha sua sequência.",
    icon: <Trophy className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(45,93%,47%)",
    glowColor2: "hsl(152,58%,45%)",
  },
  {
    ...
    description: "Chat em tempo real. Peça ajuda sempre que precisar.",
    icon: <MessageSquare className="w-5 h-5" />,
    glowColor1: "hsl(210,92%,55%)",
    glowColor2: "hsl(280,70%,50%)",
  },
  {
    ...
    subtitle: "Evolução guiada por dados",
    description: "O sistema ajusta sua estratégia conforme sua resposta metabólica.",
    icon: <Target className="w-5 h-5" />,
    reverse: true,
  },
  {
    image: pSlide7,
    title: "Checklist diário personalizado",
    subtitle: "Seu dia organizado",
    description: "Tarefas de nutrição, hidratação e hábitos saudáveis num só lugar.",
    icon: <Shield className="w-5 h-5" />,
    glowColor1: "hsl(152,58%,45%)",
    glowColor2: "hsl(210,92%,55%)",
  },
  {
    image: pSlide8,
    title: "Gamificação que transforma",
    subtitle: "Conquiste e evolua",
    description: "Medalhas, níveis e fases da sua jornada. Evolução nunca foi tão motivante.",
    icon: <Trophy className="w-5 h-5" />,
    reverse: true,
    glowColor1: "hsl(45,93%,47%)",
    glowColor2: "hsl(152,58%,45%)",
  },
  {
    ...
    subtitle: "Cada escolha conta",
    description: "Relatórios semanais mostram como cada decisão contribui para seu resultado.",
    icon: <BarChart3 className="w-5 h-5" />,
    glowColor1: "hsl(280,70%,50%)",
    glowColor2: "hsl(210,92%,55%)",
  },
  {
    ...
    subtitle: "Tudo está pronto",
    description: "Siga o plano, confie no processo e veja a transformação acontecer.",
...
function FeatureCard({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <motion.div
      ...
      className="flex items-center gap-3 px-5 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm"
    >
...
function ShowcaseBlock({ section, index }: { section: ShowcaseSection; index: number }) {
  ...
  return (
    <div className={`grid md:grid-cols-2 gap-10 lg:gap-16 items-center ${isReverse ? "" : ""}`}>
      {/* Text */}
      <motion.div
...
/* ── Gallery grid for extra screenshots ── */
function GalleryGrid({ images, isPro }: { images: string[]; isPro: boolean }) {
  return (
...
export default function PublicDemo() {
  ...
  // Extra gallery images (remaining slides)
  ...
  const features = isPro ? proFeatures : patientFeatures;
    ...
    <div className="min-h-screen mesh-gradient-bg">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/70 text-sm font-medium">
              Demo {isPro ? "Profissional" : "Paciente"}
            </span>
          </div>
          <Button
            size="sm"
      ...
      <section className="pt-28 pb-16 md:pt-36 md:pb-24 px-6 text-center relative overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background: `radial-gradient(ellipse, ${accent.replace(")", ",0.12)")} 0%, transparent 70%)`,
            filter: "blur(80px)",
          }}
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-4">
            {features.map((f, i) => (
              ...
              >
                <FeatureCard icon={f.icon} label={f.label} />
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <span className="text-white/30 text-xs">Role para explorar</span>
      ...
      <section className="px-6 pb-20 md:pb-28">
        ...
        >
          <EnergyGlow intensity={0.15} />
          <MockupParticles count={8} />
          <EnergyBeam className="top-4 right-12" angle={150} />
          <EnergyBeam className="bottom-8 left-8" angle={30} color="hsl(210,92%,55%)" />
          <PremiumMockupFrame>
            <img
              src={isPro ? screenshotDashboard : pSlide1}
              alt={isPro ? "Dashboard FitJourney" : "App do Paciente"}
              className="rounded-xl w-full relative z-10"
            />
          </PremiumMockupFrame>
        </motion.div>
      ...
      {/* ── Showcase sections ── */}
      <section className="px-6 space-y-24 md:space-y-36 pb-24 md:pb-36">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-white/40 text-base md:text-lg max-w-2xl mx-auto">
              Explore a riqueza de funcionalidades disponíveis no FitJourney
            </p>
          </motion.div>
          <GalleryGrid images={galleryImages} isPro={isPro} />
        </div>
      </section>
        ...
        >
          <div className="relative inline-block">
            <motion.div
              ...
              style={{
                background: `radial-gradient(circle, ${accent.replace(")", ",0.15)")} 0%, transparent 70%)`,
                filter: "blur(40px)",
              }}
          ...
          <p className="text-white/50 text-lg max-w-xl mx-auto">
            {isPro
              ? "Junte-se a profissionais que já transformaram seus consultórios com o FitJourney."
              : "Comece sua jornada de transformação agora com acompanhamento inteligente."
            }
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              onClick={() => navigate("/auth")}
              className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-8 py-6 rounded-2xl gap-2 shadow-[0_0_30px_hsl(var(--primary)/0.3)]"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              onClick={() => navigate(isPro ? "/demo/paciente" : "/demo/profissional")}
              className="text-lg px-8 py-6 rounded-2xl gap-2 border-white/[0.15] text-white/70 hover:text-white hover:bg-white/[0.06]"
            >
              <Play className="w-5 h-5" />
              Ver demo {isPro ? "Paciente" : "Profissional"}
            </Button>
          </div>
