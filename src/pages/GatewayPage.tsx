...
/* ─── Card data — ordered: Profissional, Paciente, Personal, Afiliado ─── */
const cardMeta = [
  {
    icon: Stethoscope,
...
function RoleCard({
  ...
  return (
    ...
    >
      <motion.div
        className="relative rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-sm p-5 hover:bg-white/[0.06] transition-colors duration-300 h-full"
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#060a10]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-[hsl(var(--primary)/0.05)] blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        <section className="w-full max-w-5xl pt-16 md:pt-24 pb-10 md:pb-16 flex flex-col items-center gap-8">
          ...
          >
            <div className="absolute -inset-8 rounded-full bg-[radial-gradient(circle,hsl(var(--primary)/0.08)_0%,transparent_65%)] blur-xl pointer-events-none" />
          ...
          >
            <h1 className="text-2xl md:text-4xl font-bold leading-tight mb-3 bg-gradient-to-r from-[hsl(152,58%,50%)] via-[hsl(170,55%,48%)] to-[hsl(40,65%,58%)] bg-clip-text text-transparent">
              {headline}
            </h1>
        ...
        <section className="w-full max-w-4xl py-16 md:py-24">
          ...
          >
            <h2 className="text-xl md:text-3xl font-bold text-white mb-3">
              ...
              <span className="bg-gradient-to-r from-[hsl(152,58%,50%)] to-[hsl(170,55%,48%)] bg-clip-text text-transparent">diferente?</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {pillars.map((pillar, i) => (
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-[hsl(var(--primary)/0.08)] flex items-center justify-center mb-4 group-hover:bg-[hsl(var(--primary)/0.14)] transition-colors duration-300">
