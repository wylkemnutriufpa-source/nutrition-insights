...
export default function PatientMealPlan() {
  ...
  // 🛡️ SOBERANIA V3: dayOfWeek sempre derivado da data selecionada pelo usuário.
  // Remover dependência circular de items[0].day_of_week que causava dia errado ao navegar.
