...
import {
  ...
  CalendarDays, FileText, ChevronDown, Filter, Search, X,
  ArrowRight, BarChart3, Heart
} from "lucide-react";
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto space-y-6 p-4 md:p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="font-display text-2xl md:text-3xl font-bold tracking-tight">Risco Clínico</h1>
...
function IndicatorCard({ label, value, icon: Icon, status }: {
  ...
  return (
    <div className="rounded-lg border bg-card/50 p-3">
      ...
      <p className={`font-display text-lg font-bold ${colors[status]}`}>{value}</p>
    </div>
  );
}
