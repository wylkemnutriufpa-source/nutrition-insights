    ...
    <div className="min-h-screen bg-[#0a0a14] text-white overflow-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/auth">
            <Button size="sm" className="bg-amber-500 hover:bg-amber-600 text-black font-bold">Quero Ser Embaixador</Button>
          </Link>
        </div>
      </nav>
      ...
      <section className="relative px-6 pt-16 pb-24 max-w-6xl mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto mb-6">
            Indique profissionais e pacientes para o FitJourney e receba comissões recorrentes.
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Por que ser um{" "}
            <span className="text-amber-400">Embaixador</span>?
          </h2>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((s, i) => (
            ...
            >
              <div className="text-5xl font-black bg-gradient-to-b from-amber-400 to-amber-600 bg-clip-text text-transparent mb-4">
                {s.step}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {tiers.map((t, i) => (
            <motion.div
              ...
              className={`rounded-xl border ${t.color} bg-white/[0.02] p-6 text-center`}
            >
      ...
      <section className="px-6 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Pronto para <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">ganhar</span>?
          </h2>
          <p className="text-white/40 mb-8">Junte-se ao programa de embaixadores e comece a ganhar comissões hoje.</p>
          <Link to="/auth">
