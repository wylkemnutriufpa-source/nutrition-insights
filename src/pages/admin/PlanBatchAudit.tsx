    ...
    try {
      ...
      const { data: newPlan, error: insertErr } = await supabase
        ...
        .insert({
          ...
          protein_target: originalPlan.protein_target,
          carbs_target: originalPlan.carbs_target,
          fat_target: originalPlan.fat_target,
          daily_calories: originalPlan.daily_calories,
          meal_count: originalPlan.meal_count,
          diet_type: originalPlan.diet_type,
          template_used: originalPlan.template_used,
