        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            {!isImmutable && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  {!isAutoGenerated && (
                    <DropdownMenuItem onClick={() => navigate(`/v3/${plan?.patient_id}?planId=${id}`)} className="gap-2 text-primary">
            ...
            {plan && tenantId && !isAutoGenerated && !isImmutable && (
              <SimplifyPlanButton
                ...
                tenantId={tenantId}
                items={store.items}
                onSimplified={(newId) => navigate(`/v3/${plan?.patient_id}?planId=${newId}`, { replace: true })}
              />
            )}
