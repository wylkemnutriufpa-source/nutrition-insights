  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      const pdfData: PremiumMealPlanPDFData = {
        ...
        targetCarbs: (plan.total_meta_carboidratos && plan.total_meta_carboidratos > 5) ? plan.total_meta_carboidratos : avgCarbs,
        targetFat: (plan.total_meta_gorduras && plan.total_meta_gorduras > 2) ? plan.total_meta_gorduras : avgFat,
