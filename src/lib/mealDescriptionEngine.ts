 ...
 * 
 * This is a CLIENT-SIDE mirror of supabase/functions/_shared/meal-description.ts
 * Both files MUST stay in sync. The server version is the canonical source.
 * 
 * Used by: autoFixEngine, mealItemBuilder, UI components
 * 
 * v1.0.0
 */
...
// Protein distribution moved to mealPlanFoodRules.ts (canonical location for macro rules)
