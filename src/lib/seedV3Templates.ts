...
// Dicionário de alimentos enriquecido com mapeamento real do storage
const FOODS = {
  ...
  banana: { title: 'Banana Prata', qty: '1 unidade', mass: 70, m: {kcal: 70, protein_g: 1, carbs_g: 18, fat_g: 0}, img: `${BASE_IMG}/abacate.jpg` },
