...
export const FEATURE_REGISTRY: FeatureDefinition[] = [
  ...
  { name: "progress_simulation", label: "Simulação de Progresso", description: "Projeção de evolução do paciente baseada em adesão atual vs otimizada", icon: Activity, category: "Inteligência Clínica", addedVersion: "3.0" },
];
