...
BEGIN
  ...
  -- Advisory model: only block if never validated (NULL)
  ...
  VALUES (_plan.patient_id, _nutritionist_id, 'plan_published', 'Plano aprovado e publicado', 'Plano alimentar foi aprovado e publicado para o paciente.');
