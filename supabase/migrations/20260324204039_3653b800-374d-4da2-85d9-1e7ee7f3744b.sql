...
-- 1) Change journey_status default from 'active' to 'invited'
ALTER TABLE public.nutritionist_patients ALTER COLUMN journey_status SET DEFAULT 'invited';

-- 2) Fix complete_patient_onboarding_by_patient: remove plan_generated requirement
