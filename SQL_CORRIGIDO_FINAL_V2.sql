-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- INTEGRAÇÃO DOS TEMPLATES NO EDITOR V3 - VERSÃO CORRIGIDA V2
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
SELECT 
  ...
  COALESCE(
    t.description, 
    CASE 
      WHEN t.dietary_restrictions IS NOT NULL THEN 'Template com restrições alimentares'
  ...
  END as objective,
  CASE 
    WHEN t.dietary_restrictions IS NOT NULL THEN 'Restrições Alimentares'
