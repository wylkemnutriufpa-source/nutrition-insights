...
const FOODS: Record<string, FoodItem> = {
  ...
  peito_frango: { name: 'Peito de Frango', mass_g: 150, kcal: 220, protein_g: 48, carbs_g: 0, fat_g: 2, image: `${IMG}/frango-grelhado-1.jpg` },
  tilapia: { name: 'Filé de Tilápia', mass_g: 150, kcal: 200, protein_g: 40, carbs_g: 0, fat_g: 4, image: `${IMG}/file-de-tilapia.jpg` },
  salmao: { name: 'Salmão Grelhado', mass_g: 150, kcal: 280, protein_g: 35, carbs_g: 0, fat_g: 18, image: `${IMG}/file-de-tilapia.jpg` },
  linguado: { name: 'Filé de Linguado', mass_g: 150, kcal: 180, protein_g: 38, carbs_g: 0, fat_g: 2, image: `${IMG}/file-de-tilapia.jpg` },
  carne_vermelha: { name: 'Carne Vermelha', mass_g: 150, kcal: 320, protein_g: 38, carbs_g: 0, fat_g: 18, image: `${IMG}/carne-grelhada.jpg` },
  patinho: { name: 'Patinho Moído', mass_g: 150, kcal: 300, protein_g: 40, carbs_g: 0, fat_g: 12, image: `${IMG}/carne-grelhada.jpg` },
  maminha: { name: 'Maminha Grelhada', mass_g: 120, kcal: 270, protein_g: 39, carbs_g: 0, fat_g: 12, image: `${IMG}/maminha.jpg` },
  atum: { name: 'Atum em Lata', mass_g: 100, kcal: 130, protein_g: 28, carbs_g: 0, fat_g: 1, image: `${IMG}/file-de-tilapia.jpg` },
  sardinha: { name: 'Sardinha', mass_g: 100, kcal: 180, protein_g: 24, carbs_g: 0, fat_g: 10, image: `${IMG}/file-de-tilapia.jpg` },
  ovos_mexidos: { name: 'Ovos Mexidos', mass_g: 150, kcal: 220, protein_g: 18, carbs_g: 1, fat_g: 15, image: `${IMG}/ovos-mexidos.jpg` },
  ovos_fritos: { name: 'Ovos Fritos', mass_g: 100, kcal: 180, protein_g: 12, carbs_g: 1, fat_g: 14, image: `${IMG}/ovos-cozidos.jpg` },
  ovos_cozidos: { name: 'Ovos Cozidos', mass_g: 100, kcal: 155, protein_g: 13, carbs_g: 1, fat_g: 11, image: `${IMG}/ovos-cozidos.jpg` },
  
  // CARBOIDRATOS
  arroz_branco: { name: 'Arroz Branco', mass_g: 100, kcal: 130, protein_g: 2, carbs_g: 28, fat_g: 0, image: `${IMG}/carne-com-batata.jpg` },
  arroz_integral: { name: 'Arroz Integral', mass_g: 100, kcal: 120, protein_g: 3, carbs_g: 25, fat_g: 1, image: `${IMG}/carne-com-batata.jpg` },
  batata_doce: { name: 'Batata Doce', mass_g: 120, kcal: 90, protein_g: 1, carbs_g: 20, fat_g: 0, image: `${IMG}/frango-com-batata-doce.jpg` },
  batata_branca: { name: 'Batata Branca', mass_g: 120, kcal: 100, protein_g: 2, carbs_g: 23, fat_g: 0, image: `${IMG}/carne-com-batata.jpg` },
  macarrao: { name: 'Macarrão', mass_g: 100, kcal: 150, protein_g: 5, carbs_g: 30, fat_g: 1, image: `${IMG}/macarrao-com-carne-moida.jpg` },
  pao_integral: { name: 'Pão Integral', mass_g: 50, kcal: 120, protein_g: 4, carbs_g: 24, fat_g: 1, image: `${IMG}/torrada-integral.jpg` },
  tapioca: { name: 'Tapioca', mass_g: 50, kcal: 150, protein_g: 0, carbs_g: 37, fat_g: 0, image: `${IMG}/crepioca.jpg` },
  polenta: { name: 'Polenta', mass_g: 100, kcal: 140, protein_g: 3, carbs_g: 28, fat_g: 1, image: `${IMG}/carne-com-batata.jpg` },
  milho: { name: 'Milho', mass_g: 100, kcal: 110, protein_g: 3, carbs_g: 24, fat_g: 1, image: `${IMG}/milho-cozido.jpg` },
  mandioca: { name: 'Mandioca Cozida', mass_g: 100, kcal: 125, protein_g: 1, carbs_g: 30, fat_g: 0, image: `${IMG}/macaxeira-com-cafe.jpg` },
  macaxeira: { name: 'Macaxeira', mass_g: 100, kcal: 125, protein_g: 1, carbs_g: 30, fat_g: 0, image: `${IMG}/bolo-de-macaxeira-com-cafe.jpg` },
  inhame: { name: 'Inhame', mass_g: 100, kcal: 115, protein_g: 2, carbs_g: 27, fat_g: 0, image: `${IMG}/carne-com-batata.jpg` },
  cuscuz: { name: 'Cuscuz', mass_g: 100, kcal: 112, protein_g: 4, carbs_g: 23, fat_g: 0, image: `${IMG}/cuscuz-com-ovo.jpg` },
  aveia: { name: 'Aveia em Flocos', mass_g: 30, kcal: 110, protein_g: 4, carbs_g: 17, fat_g: 2, image: `${IMG}/banana-com-aveia.jpg` },
  granola: { name: 'Granola', mass_g: 30, kcal: 140, protein_g: 4, carbs_g: 18, fat_g: 5, image: `${IMG}/iogurte-com-ganola.jpg` },
  
  // LEGUMINOSAS
  feijao_carioca: { name: 'Feijão Carioca', mass_g: 80, kcal: 70, protein_g: 5, carbs_g: 13, fat_g: 0, image: `${IMG}/carne-com-batata.jpg` },
  
  // VEGETAIS LIVRES
  salada_verde: { name: 'Salada Verde', mass_g: 100, kcal: 15, protein_g: 1, carbs_g: 3, fat_g: 0, image: `${IMG}/salada-completa.jpg` },
  legumes_vapor: { name: 'Legumes no Vapor', mass_g: 100, kcal: 40, protein_g: 2, carbs_g: 8, fat_g: 0, image: `${IMG}/peixe-com-legumes.jpg` },
  brocolis: { name: 'Brócolis', mass_g: 100, kcal: 35, protein_g: 3, carbs_g: 7, fat_g: 0, image: `${IMG}/peixe-com-legumes.jpg` },
  couve: { name: 'Couve', mass_g: 100, kcal: 30, protein_g: 3, carbs_g: 5, fat_g: 0, image: `${IMG}/salada-completa.jpg` },
  tomate: { name: 'Tomate', mass_g: 100, kcal: 18, protein_g: 1, carbs_g: 4, fat_g: 0, image: `${IMG}/salada-completa.jpg` },
