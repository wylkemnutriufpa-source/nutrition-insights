-- ============================================================
-- NOS SPRINT F — FIX: Re-execução segura (idempotente)
-- Cole este SQL no Supabase SQL Editor
-- ============================================================
-- O erro anterior era RAISE NOTICE fora de DO $$.
-- Esta versão corrige isso e é segura para re-executar.
...
-- ────────────────────────────────────────────────────────────
-- TABELA 4: nos_nutritionist_library
-- ────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────
-- SEED: 60 alimentos TACO (idempotente — ON CONFLICT DO NOTHING)
-- ────────────────────────────────────────────────────────────
...
-- Atualizar hash e name_normalized
...
-- Verificação final (sem RAISE fora de DO)
DO $$
DECLARE v_count int;
BEGIN
